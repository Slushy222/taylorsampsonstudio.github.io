document.addEventListener('DOMContentLoaded', function() {
    const overlays = document.querySelectorAll('.neonOverlay, .lamentOverlay, .speakOverlay, .voteOverlay, .roomOverlay, .animaOverlay, .uniOverlay');
    ...
    const overlayColors = {
      neonOverlay: 'rgb(255, 180, 0)',
      lamentOverlay: 'rgb(246,231,203)',
      speakOverlay: 'rgb(255, 0, 128)',
      voteOverlay: 'rgb(144,180,148)',
      roomOverlay: 'rgb(164, 74, 63)',
      animaOverlay: 'rgb(255, 128, 0)',
      uniOverlay: 'rgb(112,214,255)'
    ...
    document.body.addEventListener('click', function(event) {
      const isOverlay = event.target.closest('.neonOverlay, .lamentOverlay, .speakOverlay, .voteOverlay, .roomOverlay, .animaOverlay, .uniOverlay');
      const isMainContentImage = event.target.classList.contains('mainContentImages');
